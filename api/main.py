...
async def upload_file(file: UploadFile = File(...)):
    ...
    try:
        ...
        # --- Robust CSV decoding (fixes UnicodeDecodeError for non-UTF8 CSVs) ---
        try:
        ...
        # Coerce feature columns too (safe)
        ...
        # Drop rows where sales is missing after coercion
        ...
        # Minimum rows guard (after cleaning)
        if len(df_work) < 20:
